...
def on_config(config, **kwargs):
    ...
    for category in data.get('categories', []):
        ...
        for pair in category.get('pairs', []):
            ...
            content += "</tr>\n"
            content += "<tr markdown=\"block\">\n"
            content += f"<td markdown=\"block\">\n\n<iframe width=\"320\" height=\"180\" src=\"{pair['jewish_url']}\" frameborder=\"0\" allow=\"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture\" allowfullscreen></iframe>\n\n</td>\n"
            content += f"<td markdown=\"block\">\n\n<iframe width=\"320\" height=\"180\" src=\"{pair['source_url']}\" frameborder=\"0\" allow=\"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture\" allowfullscreen></iframe>\n\n</td>\n"
            content += "</tr>\n"
